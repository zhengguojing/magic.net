...
namespace Magic.Core
{
	public static class DataFilterExtensions
	{
        ...
        /// <returns></returns>
        public static ISugarQueryable<TEntity> ToDataFilter<TEntity>(this ISugarQueryable<TEntity> query, string field = "", FilterType type = FilterType.User)
        {
            ...
            {
                query = query.MergeTable().Where((Expression<Func<TEntity, bool>>)expression);
            }
            return query;
        }
        /// <summary>
