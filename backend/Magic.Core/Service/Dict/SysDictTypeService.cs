...
namespace Magic.Core.Service
{
    ...
    public class SysDictTypeService : ISysDictTypeService, IDynamicApiController, ITransient
    {
        ...
        {
            var dictTypes = await _sysDictTypeRep.Context.Queryable<SysDictType>()
        ...
        public async Task AddDictType(AddDictTypeInput input)
        {
            ...
            var typeId = await _sysDictTypeRep.Context.Insertable(dictType).CallEntityMethod(m=>m.Create()).ExecuteReturnSnowflakeIdAsync();
        ...
        public async Task UpdateDictType(UpdateDictTypeInput input)
        {
            ...
            var dictType = input.Adapt<SysDictType>();
            await _sysDictTypeRep.Context.Updateable(dictType).IgnoreColumns(ignoreAllNullColumns: true).ExecuteCommandAsync();
        }
        ...
        public async Task ChangeDictTypeStatus(UpdateDictTypeInput input)
        {
            ...
            await _sysDictTypeRep.Context.Updateable(dictType).CallEntityMethod(m => m.Modify()).ExecuteCommandAsync();
        }
