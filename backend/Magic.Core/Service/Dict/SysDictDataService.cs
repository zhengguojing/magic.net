...
namespace Magic.Core.Service
{
    ...
    public class SysDictDataService : ISysDictDataService, IDynamicApiController, ITransient
    {
        ...
        public async Task<dynamic> QueryDictDataPageList([FromQuery] DictDataInput input)
        {
            ...
            var dictDatas = await _sysDictDataRep.Context.Queryable<SysDictData>()
        ...
        {
            return await _sysDictDataRep.Context.Queryable<SysDictData>()
        ...
        public async Task AddDictData(AddDictDataInput input)
        {
            ...
            await _sysDictDataRep.Context.Insertable(dictData).CallEntityMethod(m=>m.Create()).ExecuteCommandAsync();
        }
        ...
        public async Task UpdateDictData(UpdateDictDataInput input)
        {
            ...
            var dictData = input.Adapt<SysDictData>();
            await _sysDictDataRep.Context.Updateable(dictData).IgnoreColumns(ignoreAllNullColumns: true).ExecuteCommandAsync();
        }
