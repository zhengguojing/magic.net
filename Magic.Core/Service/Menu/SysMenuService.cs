...
namespace Magic.Core.Service
{
    ...
    public class SysMenuService : ISysMenuService, IDynamicApiController, ITransient
    {
        ...
        {
            var menus = await _sysMenuRep.Context.Queryable<SysMenu>()
        ...
        public async Task AddMenu(AddMenuInput input)
        {
            ...
            await _sysMenuRep.Context.Insertable(menu).CallEntityMethod(m => m.Create()).ExecuteCommandAsync();
        ...
        public async Task UpdateMenu(UpdateMenuInput input)
        {
            ...
            await _sysMenuRep.Context.Updateable(menuList).CallEntityMethod(m => m.Modify()).ExecuteCommandAsync();
        ...
        public async Task<dynamic> TreeForGrant([FromQuery] MenuInput input)
        {
            ...
            var menus = await _sysMenuRep.Context.Queryable<SysMenu>().LeftJoin<SysApp>((t1, t2) => t1.Application == t2.Code)
