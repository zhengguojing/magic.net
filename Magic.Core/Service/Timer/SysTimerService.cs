...
namespace Magic.Core.Service
{
    ...
    public class SysTimerService : ISysTimerService, IDynamicApiController, IScoped
    {
        ...
        public async Task<dynamic> GetTimerPageList([FromQuery] JobInput input)
        {
            ...
            var timers = await _sysTimerRep.Context.Queryable<SysTimer>()
        ...
        public async Task AddTimer(JobInput input)
        {
            ...
            await _sysTimerRep.Context.Insertable(timer).CallEntityMethod(m => m.Create()).ExecuteCommandAsync();
        ...
        public void StopTimerJob(JobInput input)
        {
            ...
            _sysTimerRep.Context.Updateable(timer).CallEntityMethod(m=>m.Modify()).ExecuteCommand();
