...
namespace Magic.Core.Service
{
    ...
    public class SysConfigService : ISysConfigService, IDynamicApiController, ITransient
    {
        ...
        {
            var configs = await _sysConfigRep.Context.Queryable<SysConfig>()
        ...
        public async Task AddConfig(AddConfigInput input)
        {
            ...
            await _sysConfigRep.Context.Insertable(config).CallEntityMethod(m => m.Create()).ExecuteCommandAsync();
        }
        ...
        public async Task UpdateConfig(UpdateConfigInput input)
        {
            ...
            var config = input.Adapt<SysConfig>();
            await _sysConfigRep.Context.Updateable(config).IgnoreColumns(ignoreAllNullColumns: true).ExecuteCommandAsync();
            //刷新缓存
